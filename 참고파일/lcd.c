...
static void LCD_Configuration(void)
{
	...
	/*DB00~DB16*/
	/*DB00~DB16*/
	// SAFE MODE: Exclude PE2 (PIR), PE3 (Touch), PE9 (Servo)
	// These pins are used by sensors. LCD will skip driving them.
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_All & ~(GPIO_Pin_2 | GPIO_Pin_3 | GPIO_Pin_9);
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
	GPIO_Init(GPIOE, &GPIO_InitStructure);
